<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  <defs>
    ...
    <symbol id="logout" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path fill="currentColor"
        d="M10 12.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0V4.5H5v7h4.5v-3a.5.5 0 0 1 1 0v3z" />
      <path fill="currentColor"
        d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L14.293 8l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z" />
    </symbol>
  ...
  <div class="offcanvas-body">
    <div class="order-md-last">
      <h4 class="d-flex justify-content-between align-items-center mb-3">
        ...
        <span class="badge bg-success rounded-pill"><?= count($_SESSION['cart'] ?? []) ?></span>
      </h4>
      <ul class="list-group mb-3">
        ...
        foreach ($_SESSION['cart'] ?? [] as $item) {
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0"><?= $item['designation'] ?></h6>
              <small class="text-body-secondary">Quantité: <?= $item['quantite'] ?></small>
            </div>
            <span class="text-body-secondary"><?= $subtotal ?> DH</span>
          </li>
        <?php } ?>
      ...
      <a href="../../Gestion_Actions/acheteur/acheteur_actions.php?action=checkout"
        class="w-100 btn btn-success btn-lg">Passer la Commande</a>
    </div>
  </div>
</div>
    ...
    <div class="row py-3 border-bottom">
      ...
      <div
        ...
        <div class="support-box text-end d-none d-xl-block">
          <span class="fs-6 text-muted">Contact</span>
          <h5 class="mb-0">05-391 122 33 44</h5>
        </div>

        <ul class="d-flex justify-content-end list-unstyled m-0">
          <li>
            <a href="../acheteur/profile.php" class="rounded-circle bg-light p-2 mx-1">
          ...
          <li>
            <a href="../../gestion_actions/logout.php" class="rounded-circle bg-light p-2 mx-1">
              <svg width="24" height="24" viewBox="0 0 24 24">
