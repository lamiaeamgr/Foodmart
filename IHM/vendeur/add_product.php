        ...
        <form action="../../Gestion_Actions/vendeur/vendeur_actions.php?action=add_product" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="quantite_stock"><i class="bi bi-box-seam"></i> Quantité en Stock</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="date_peremption"><i class="bi bi-calendar-x"></i> Date de Péremption</label>
                    ...
                    <div class="form-group">
                        <label for="image_upload"><i class="bi bi-image"></i> Image du Produit</label>
                        <input type="file" class="form-control" id="image_upload" name="image_upload" accept="image/*" required>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-submit mt-4">Ajouter le Produit <i class="bi bi-check2"></i></button>
        </form>
    </div>
