...
if (!isset($_SESSION['coupons'])) {
    header("Location: ../../Gestion_Actions/acheteur/acheteur_actions.php?action=view_coupons");
    exit;
}
...
if (!$client) {
    header("Location: ../../Gestion_Actions/acheteur/acheteur_actions.php?action=view_points");
    exit;
}
?>
<!DOCTYPE html>
                ...
                <div class="coupon-ticket">
                    ...
                    <div class="coupon-stats">
                        <div class="stat-item">
                            ...
                            <div class="stat-value"><?= htmlspecialchars($coupon['code']) ?></div>
                        </div>
                        <div class="stat-item">
                        ...
                        <div class="stat-item">
                            ...
                            <div class="stat-value">
                                <?= htmlspecialchars($coupon['valeur'])?> DH</div>
                        </div>
                    </div>
